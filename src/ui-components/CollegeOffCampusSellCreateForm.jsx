...
export default function CollegeOffCampusSellCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CollegeOffCampusSell(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CollegeOffCampusSellCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
